...
mod paperdoll_tests {
    use game_core::{
        items::{DollSlot, Item, ItemInfo, ItemLocation, PaperDoll, UniqueItem},
        object_id::ObjectId,
    };
    ...
    fn test_set_and_get() {
        ...
        paperdoll.equip_without_validations(DollSlot::Head, item1);
        paperdoll.equip_without_validations(DollSlot::Chest, item2);
        paperdoll.equip_without_validations(DollSlot::Legs, item3);
