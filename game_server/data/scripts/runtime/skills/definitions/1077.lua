...
local definition = {
    ...
    levels = 3,
    name = "Focus",
    description = "Increases Critical Rate by 20% for 20 minutes.",
    kind = "Active",
    tables = {
        abnormalLevels = { 1, 2, 3 },
        effectPoints = { 243, 418, 495 },
        magicLevel = { 7, 25, 44 },
        mpConsume = { 18, 31, 38 },
        mpInitialConsume = { 5, 8, 10 },
        stats = {
            CriticalRate = { "Mul", { 1.2, 1.25, 1.3 } },
        },
    },
    other = {
        abnormalTime = 1200000, -- 20 minutes in milliseconds
        abnormalKind = "CriticalRateUp",
        castRange = 400,
        effectRange = 900,
        hitTime = 4000,
        reuseDelay = 2000,
